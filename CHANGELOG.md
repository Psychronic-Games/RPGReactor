...
- **The Web editor bundle fits browser storefronts' 1000-file upload cap again.** Unreferenced library stock — hud face skins for undefined actors, source files, unused stock enemy battlers — is trimmed at packaging time, taking the archive to roughly 740 files with a test-enforced 900-file ceiling; the soundtrack and browsing libraries ship untouched.
