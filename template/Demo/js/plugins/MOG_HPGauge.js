...
/*:
 * @target MZ
 * @plugindesc (v1.0) Displays a target HP gauge.
 * @author Moghunter
 * @url https://mogplugins.wordpress.com
 *
 * @param Gauge For Actors
 * @desc Display HP on allies.
 * @default true
 * @type boolean 
 *
 * @param Gauge For Enemies
 * @desc Display HP on enemies. 
 * @default true
 * @type boolean  
 *
 * @param Show HP On Selection
 * @desc Display HP on target selection. 
 * @default true
 * @type boolean 
 * 
 * @param Fade Duration
 * @desc Fade activation time definition.
 * @default 90
 *
 * @param Slide Animation
 * @desc Enable slide animation.
 * @default true
 * @type boolean 
 *  
 * @param Show HP Number Actor
 * @desc Display HP number for the actor. 
 * @default false
 * @type boolean 
 *
 * @param Show HP Number Enemy
 * @desc Display HP number for the enemy. 
 * @default true
 * @type boolean 
 *
 * @param Required to Kill
 * @desc Requires defeating the enemy to show HP. 
 * @default false
 * @type boolean 
 * 
 * @param Actor Layout X-Axis
 * @desc X-Axis position for layout.
 * @default 5
 *
 * @param Actor Layout Y-Axis
 * @desc Y-Axis position for layout.
 * @default -90
 *
 * @param Actor Meter X-Axis
 * @desc X-Axis position for gauge.
 * @default 0
 *
 * @param Actor Meter Y-Axis
 * @desc Y-Axis position for gauge.
 * @default 3 
 *
 * @param Actor HP Number X-Axis
 * @desc X-Axis position for HP number.
 * @default -25
 *
 * @param Actor HP Number Y-Axis
 * @desc Y-Axis position for HP number.
 * @default -22
 * 
