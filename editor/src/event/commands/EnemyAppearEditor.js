/**
 * EnemyAppearEditor - Editor for Enemy Appear event command (code 335)
 */
class EnemyAppearEditor {
    ...
    createModal() {
        ...
        this.modal.className = 'enemy-appear-editor-modal';
        ...
        container.className = 'enemy-appear-container';
    ...
    renderContent() {
        ...
        const container = this.modal.querySelector('.enemy-appear-container');
        container.innerHTML = '';
        ...
        `;
        header.innerHTML = `
            <h3 style="margin: 0; color: var(--color-text-strong); font-size: 16px;">${tt('Enemy Appear')}</h3>
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = EnemyAppearEditor;
}
