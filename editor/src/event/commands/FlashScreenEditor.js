/**
 * FlashScreenEditor - Editor for Flash Screen event command (code 224)
 */
class FlashScreenEditor {
    ...
    /**
     * Show editor for a flash screen command
    ...
    show(command, callback) {
        ...
        if (command && command.code === 224) {
            const params = command.parameters;
            const color = params[0] || [255, 255, 255, 190];
            this.colorR = color[0] !== undefined ? color[0] : 255;
            this.colorG = color[1] !== undefined ? color[1] : 255;
            this.colorB = color[2] !== undefined ? color[2] : 255;
            this.colorA = color[3] !== undefined ? color[3] : 190;
            this.duration = params[1] !== undefined ? params[1] : 8;
    ...
    createModal() {
        ...
        this.modal.className = 'flash-screen-editor-modal';
        ...
        container.className = 'flash-screen-container rr-modal';
    ...
    renderContent() {
        ...
        header.innerHTML = `
            <div class="rr-modal-title">${tt('Flash Screen')}</div>
        ...
        // Color sliders
        content.appendChild(this.createSliderInput('Red:', this.colorR, 0, 255, (val) => { this.colorR = val; }));
        content.appendChild(this.createSliderInput('Green:', this.colorG, 0, 255, (val) => { this.colorG = val; }));
        content.appendChild(this.createSliderInput('Blue:', this.colorB, 0, 255, (val) => { this.colorB = val; }));
        content.appendChild(this.createSliderInput('Alpha:', this.colorA, 0, 255, (val) => { this.colorA = val; }));
        ...
        waitCheckbox.id = 'flash-screen-wait';
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = FlashScreenEditor;
}
