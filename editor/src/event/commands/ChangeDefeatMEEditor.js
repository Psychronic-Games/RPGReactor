/**
 * ChangeDefeatMEEditor - Editor for Change Defeat ME event command (code 139)
 */
class ChangeDefeatMEEditor {
    ...
    /**
     * Show editor for a change defeat ME command
    ...
    createModal() {
        ...
        this.modal.className = 'change-defeat-me-editor-modal';
        ...
        container.className = 'change-defeat-me-container';
    ...
    renderContent() {
        ...
        header.innerHTML = `
            <div class="rr-modal-title">${tt('Change Defeat ME')}</div>
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ChangeDefeatMEEditor;
}
