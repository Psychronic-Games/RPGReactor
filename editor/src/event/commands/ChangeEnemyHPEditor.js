/**
 * ChangeEnemyHPEditor - Editor for Change Enemy HP event command (code 331)
 */
class ChangeEnemyHPEditor {
    constructor(databaseManager, projectController) {
        ...
        // Parameters: [enemyIndex, operation, operandType, operand, allowDeath]
    ...
    createModal() {
        ...
        this.modal.className = 'change-enemy-hp-editor-modal';
        ...
        container.className = 'change-enemy-hp-container';
    ...
    renderContent() {
        ...
        const container = this.modal.querySelector('.change-enemy-hp-container');
        container.innerHTML = '';
        ...
        `;
        header.innerHTML = `
            <h3 style="margin: 0; color: var(--color-text-strong); font-size: 16px;">${tt('Change Enemy HP')}</h3>
        ...
        deathCheckbox.id = 'allow-death-331';
    ...
    createOperationSection() {
        ...
        increaseRadio.name = 'operation-331';
        increaseRadio.id = 'increase-331';
        ...
        increaseLabel.htmlFor = 'increase-331';
        ...
        decreaseRadio.name = 'operation-331';
        decreaseRadio.id = 'decrease-331';
        ...
        decreaseLabel.htmlFor = 'decrease-331';
    ...
    createOperandSection() {
        ...
        constRadio.name = 'operand-type-331';
        constRadio.id = 'constant-331';
        ...
        constLabel.htmlFor = 'constant-331';
    ...
    buildCommand() {
        return {
            code: 331,
            indent: 0,
            parameters: [this.enemyIndex, this.operation, this.operandType, this.operand, this.allowDeath]
        };
    }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ChangeEnemyHPEditor;
}
