/**
 * LabelEditor - Editor for Label event command (code 118)
 */
class LabelEditor {
    ...
    /**
     * Show editor for a label command
    ...
    createModal() {
        ...
        this.modal.className = 'label-editor-modal';
        ...
        container.className = 'label-container rr-modal';
    ...
    renderContent() {
        ...
        const container = this.modal.querySelector('.label-container');
        container.innerHTML = '';
        ...
        header.innerHTML = `
            <div class="rr-modal-title">${tt('Label')}</div>
