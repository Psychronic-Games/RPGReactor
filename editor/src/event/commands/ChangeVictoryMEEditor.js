/**
 * ChangeVictoryMEEditor - Editor for Change Victory ME event command (code 133)
 */
class ChangeVictoryMEEditor {
    ...
    /**
     * Show editor for a change victory ME command
    ...
    createModal() {
        ...
        this.modal.className = 'change-victory-me-editor-modal';
        ...
        container.className = 'change-victory-me-container';
    ...
    renderContent() {
        ...
        const container = this.modal.querySelector('.change-victory-me-container');
        container.innerHTML = '';
        ...
        header.innerHTML = `
            <h3 style="margin: 0; color: var(--color-text-strong); font-size: 16px;">${tt('Change Victory ME')}</h3>
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ChangeVictoryMEEditor;
}
