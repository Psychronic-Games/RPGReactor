/**
 * TintPictureEditor - Editor for Tint Picture event command (code 234)
 */
class TintPictureEditor {
    ...
    /**
     * Show editor for a tint picture command
    ...
    createModal() {
        ...
        this.modal.className = 'tint-picture-editor-modal';
        ...
        container.className = 'tint-picture-container rr-modal';
    ...
    renderContent() {
        ...
        header.innerHTML = `
            <div class="rr-modal-title">${tt('Tint Picture')}</div>
        ...
        waitCheckbox.id = 'tint-picture-wait';
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = TintPictureEditor;
}
