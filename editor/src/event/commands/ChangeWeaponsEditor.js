...
class ChangeWeaponsEditor {
    ...
    createModal() {
        ...
        container.className = 'change-weapons-container';
    ...
    renderContent() {
        ...
        `;
        header.innerHTML = `
            <h3 style="margin: 0; color: var(--color-text-strong); font-size: 16px;">Change Weapons</h3>
        ...
        if (this.operation === 1) {
            ...
            equipLabel.textContent = 'Include equipped weapons';
