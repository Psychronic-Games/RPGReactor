/**
 * ChangeEnemyTPEditor - Editor for Change Enemy TP event command (code 342)
 */
class ChangeEnemyTPEditor {
    ...
    createModal() {
        ...
        this.modal.className = 'change-enemy-tp-editor-modal';
        ...
        container.className = 'change-enemy-tp-container';
    ...
    renderContent() {
        ...
        const container = this.modal.querySelector('.change-enemy-tp-container');
        container.innerHTML = '';
        ...
        `;
        header.innerHTML = `
            <h3 style="margin: 0; color: var(--color-text-strong); font-size: 16px;">${tt('Change Enemy TP')}</h3>
    ...
    createOperationSection() {
        ...
        increaseRadio.name = 'operation-342';
        increaseRadio.id = 'increase-342';
        ...
        increaseLabel.htmlFor = 'increase-342';
        ...
        decreaseRadio.name = 'operation-342';
        decreaseRadio.id = 'decrease-342';
        ...
        decreaseLabel.htmlFor = 'decrease-342';
    ...
    createOperandSection() {
        ...
        constRadio.name = 'operand-type-342';
        constRadio.id = 'constant-342';
        ...
        constLabel.htmlFor = 'constant-342';
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ChangeEnemyTPEditor;
}
