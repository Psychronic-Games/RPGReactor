 ...
 * discrete-wave-equation water simulation (port of Almer Thie's
 * WaterCanvas / WaterModel, http://code.almeros.com).
 *
 * Implementation:
...
RR_ANIMATION_REGISTRY.push({
    ...
    id:           'portal',
    name:         'Portal',
    description:  'Stargate-style event horizon — runs a real discrete-wave-equation water simulation (port of the Almeros WaterCanvas), with deterministic rain drops driving a periodic ripple field. Per-pixel refraction warps the base radial gradient for the rippling-liquid look.',
