...
Synthesized from 8 parallel agents that ran the viewer on **every** file in all 8 part
categories (124 files). This is the spec the generator implements. Per-category
detail lives in the sibling `*.md` files.
