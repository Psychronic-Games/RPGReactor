...
class ChangeMPEditor {
    ...
    renderContent() {
        ...
        `;
        header.innerHTML = `
            <h3 style="margin: 0; color: var(--color-text-strong); font-size: 16px;">Change MP</h3>
    ...
    createActorSelector() {
        ...
        fixedLabel.htmlFor = 'actor-fixed-312'; fixedLabel.textContent = 'Fixed';
        ...
        varLabel.htmlFor = 'actor-variable-312'; varLabel.textContent = 'Variable';
