...
class ChangeEXPEditor {
    ...
    renderContent() {
        ...
        `;
        header.innerHTML = `
            <h3 style="margin: 0; color: var(--color-text-strong); font-size: 16px;">Change EXP</h3>
    ...
    createActorSelector() {
        ...
        fixedLabel.htmlFor = 'actor-fixed-315'; fixedLabel.textContent = 'Fixed';
        ...
        varLabel.htmlFor = 'actor-variable-315'; varLabel.textContent = 'Variable';
