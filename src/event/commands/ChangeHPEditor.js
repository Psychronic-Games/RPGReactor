...
class ChangeHPEditor {
    ...
    renderContent() {
        ...
        `;
        header.innerHTML = `
            <h3 style="margin: 0; color: var(--color-text-strong); font-size: 16px;">Change HP</h3>
    ...
    createActorSelector() {
        ...
        fixedLabel.htmlFor = 'actor-fixed-311'; fixedLabel.textContent = 'Fixed';
        ...
        varLabel.htmlFor = 'actor-variable-311'; varLabel.textContent = 'Variable';
